...
class EditUserForm extends React.Component {
  ...
  componentWillMount() {
      ...
      ajax({ 'type' : 'user-details'   },function(r){
  ...
  onDrop(files) {
    ...
    ajaxMultiparts('/ajax',this.form,function(){
    ...
    <button type="button" className="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
                ...
                <div className="row">
                                  ...
                                  <input type="text" required defaultValue={(u.first_name) ? u.first_name : ""} className="form-control" name="first_name" />  
                                  </div>
                                  ...
                                  <label >I am looking to</label>
                                   <select name="utype" defaultValue={u.type} >
